...
public class MenuController implements Initializable {
    ...
    public void abrirParametros(MouseEvent event) throws IOException {
        // Cargar la nueva ventana
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Clase_01/ventana1.fxml"));
        Parent root = loader.load();
    ...
    public void abrirGestionRoles(MouseEvent event) throws IOException {
        // Cargar la nueva ventana
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Clase_02/ventana2.fxml"));
        Parent root = loader.load();
    ...
    public void abrirGestionDepartamento(MouseEvent event) throws IOException {
        // Cargar la nueva ventana
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Clase_03/ventana3.fxml"));
        Parent root = loader.load();
    ...
    public void abrirUsuario(MouseEvent event) throws IOException {
        // Cargar la nueva ventana
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Clase_04/ventana4.fxml"));
        Parent root = loader.load();
    ...
    public void abrirEstado(MouseEvent event) throws IOException {
        // Cargar la nueva ventana
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Clase_05/ventana5.fxml"));
        Parent root = loader.load();
    ...
    public void abrirFlujo(MouseEvent event) throws IOException {
        // Cargar la nueva ventana
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Clase_06/ventana6.fxml"));
        Parent root = loader.load();
    ...
    public void abrirGestionTicket(MouseEvent event) throws IOException {
        // Cargar la nueva ventana
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Clase_07/ventana7.fxml"));
        Parent root = loader.load();
    ...
    public void abrirLista(MouseEvent event) throws IOException {
        // Cargar la nueva ventana
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Clase_08/ventana8.fxml"));
        Parent root = loader.load();
    ...
    public void abrirCambiarEstado(MouseEvent event) throws IOException {
        // Cargar la nueva ventana
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Clase_09/ventana9.fxml"));
        Parent root = loader.load();
    ...
    public void abrirNotaTicket (MouseEvent event) throws IOException {
        // Cargar la nueva ventana
        FXMLLoader loader = new FXMLLoader(getClass().getResource("/Clase_10/ventana10.fxml"));
        Parent root = loader.load();
